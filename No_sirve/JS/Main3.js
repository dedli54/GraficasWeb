...
//imagen de fondo
const skytexture = fondoTexture.load('IMAGENES/CieloTextura3.jpg');
...
//Luz Ambiental
const ambientLight = new THREE.AmbientLight(0x8A2BE2, 0.5); // (color, intensity)
scene.add(ambientLight);

// Iluminacion Focal
const spotLight1 = new THREE.SpotLight(0xffffff, 2.5); // Increase intensity
spotLight1.position.set(0, 300, 200); // Position the spotlight
spotLight1.angle = Math.PI / 8; // Sharper cone angle
spotLight1.penumbra = 0.2;
spotLight1.decay = 2;
spotLight1.distance = 600;

const spotLight2 = new THREE.SpotLight(0xffffff, 2.5); // Increase intensity
...
spotLight1.target.position.set(170, 9, -40);
scene.add(spotLight1.target);

spotLight2.target = new THREE.Object3D();
spotLight2.target.position.set(170, 9, -40);
...
function createTerrain() {
  ...
  const texture = new THREE.TextureLoader()
    .setPath("")
    .load("IMAGENES/MapaTextura3.jpg");
...
const sliders = {
  widthseg: 160,
  heightseg: 160,
  heightMap: "IMAGENES/MapaAlturas3.jpg",
  hortexture: 1,
  vertTexture: 1,
  dispScale: 120
};
...
loaderGLTF.load(
    ...
    function (gltf) {
        ...
        base1.position.set(-100, -0.5, 140); 
        ...
        base3.position.set(100, -0.5, 120);
...
loaderGLTF.load(
  ...
  function (modelin) {
    ...
    built1.position.set(90, 0, 150);
    scene.add(built1);

    built2 = modelin.scene.clone();
    built2 .scale.set(0.4, 0.4, 0.4);
    built2 .position.set(-120, 0, -180);
    scene.add(built2);
...
let cab1, cab2;
  loaderGLTF.load(
    ...
    function (modelin) {
      ...
      cab1.position.set(220, 0.1, -60);
      scene.add(cab1);

      cab2 = modelin.scene.clone();
      cab2.scale.set(4, 4, 4);
      cab2.position.set(-140, 0.1, 90);
      scene.add(cab2);
  ...
  loaderGLTF.load(
    ...
    function (modelin) {
      ...
      modeloo1.position.set(-30, 5.5, 60);
        ...
        const puntoA = new THREE.Vector3(-10, 5.5, 90);
        const puntoB = new THREE.Vector3(170, 9, -40);
...
loaderGLTF.load(
  ...
  function (modelin) {
    modeloo2 = modelin.scene;
      ...
      // Definir los puntos A y B de la ruta
      const puntoA = new THREE.Vector3(-30, 5.5, 80);
      const puntoB = new THREE.Vector3(170, 9, -40);
...
loaderGLTF.load(
  ...
  function (modelin) {
    modeloo3 = modelin.scene;
      ...
      // Definir los puntos A y B de la ruta
      const puntoA = new THREE.Vector3(40, 5.5, 70);
      const puntoB = new THREE.Vector3(170, 9, -40);
...
loaderGLTF.load(
  ...
  function (modelin) {
    modeloo4 = modelin.scene;
      ...
      // Definir los puntos A y B de la ruta
      const puntoA = new THREE.Vector3(20, 5.5, 50);
      const puntoB = new THREE.Vector3(170, 9, -40);
...
loaderGLTF.load(
  ...
  function (modelin) {
    modeloo5 = modelin.scene;
      ...
      // Definir los puntos A y B de la ruta
      const puntoA = new THREE.Vector3(0, 5.5, 60);
      const puntoB = new THREE.Vector3(170, 9, -40);
